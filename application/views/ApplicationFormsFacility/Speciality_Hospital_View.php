                        ...
                        <form action="#" class="job-post-form">
                            <div class="basic-info-input">
                                ...
                                <div id="Fee" class="collapse col-md-12">
                                    Speciality Hospital Permit Fees:
                                    <ul>
                                ...
                                <div id="Description" class="collapse col-md-12">
                                    This service enables the individuals to apply for a new Speciality Hospital Permits
                                </div>
                                ...
                                <hr>
                                <h4><i data-feather="plus-circle"></i>Application Form - New Speciality Hospital Permits
                                </h4>
                                ...
                                <!-- Speciality details -->
                                <div id="details" class="row">
                                    <label class="col-md-3 col-form-label">Specialities Proposed</label>
                                    <div class="col-md-9">
                                        <div class="row">
                                            <div class="custom-control custom-checkbox col-md-4">
                                                ...
                                                <label class="custom-control-label"
                                                    for="customCheck1">Cardiology</label>
                                            </div>
                                            <div class="custom-control custom-checkbox col-md-4">
                                                <input type="checkbox" class="custom-control-input" id="customCheck2"
                                                    name="example2" style="width:50px">
                                                <label class="custom-control-label"
                                                    for="customCheck2">Dermatology</label>
                                            </div>
                                            <div class="custom-control custom-checkbox col-md-4">
                                                <input type="checkbox" class="custom-control-input" id="customCheck222"
                                                    name="example2" style="width:50px">
                                                <label class="custom-control-label"
                                                    for="customCheck222">Endocrinology</label>
                                            </div>
                                            <div class="custom-control custom-checkbox col-md-4">
                                                <input type="checkbox" class="custom-control-input" id="customCheck3"
                                                    name="example2" style="width:50px">
                                                <label class="custom-control-label" for="customCheck3">Family
                                                    Medicine</label>
                                            </div>
                                            <div class="custom-control custom-checkbox col-md-4">
                                                <input type="checkbox" class="custom-control-input" id="customCheck4"
                                                    name="example2" style="width:50px">
                                                <label class="custom-control-label" for="customCheck4">Gastroenterology
                                                </label>
                                            </div>
                                            <div class="custom-control custom-checkbox col-md-4">
                                                <input type="checkbox" class="custom-control-input" id="customCheck5"
                                                    name="example2" style="width:50px">
                                                <label class="custom-control-label" for="customCheck5">Gastrointestinal
                                                    Endoscopy</label>
                                            </div>
                                            <div class="custom-control custom-checkbox col-md-4">
                                                <input type="checkbox" class="custom-control-input" id="customCheck6"
                                                    name="example2" style="width:50px">
                                                <label class="custom-control-label" for="customCheck6"> General
                                                    Medicine</label>
                                            </div>
                                            <div class="custom-control custom-checkbox col-md-4">
                                                <input type="checkbox" class="custom-control-input" id="customCheck7"
                                                    name="example2" style="width:50px">
                                                <label class="custom-control-label" for="customCheck7">Hematology
                                                </label>
                                            </div>
                                            <div class="custom-control custom-checkbox col-md-4">
                                                <input type="checkbox" class="custom-control-input" id="customCheck8"
                                                    name="example2" style="width:50px">
                                                <label class="custom-control-label" for="customCheck8">Immunology
                                                </label>
                                            </div>
                                            <div class="custom-control custom-checkbox col-md-4">
                                                <input type="checkbox" class="custom-control-input" id="customCheck9"
                                                    name="example2" style="width:50px">
                                                <label class="custom-control-label" for="customCheck9">Internal
                                                    Medicine</label>
                                            </div>
                                            <div class="custom-control custom-checkbox col-md-4">
                                                <input type="checkbox" class="custom-control-input" id="customCheck10"
                                                    name="example10" style="width:50px">
                                                <label class="custom-control-label" for="customCheck10">Nephrology
                                                </label>
                                            </div>
                                            <div class="custom-control custom-checkbox col-md-4">
                                                <input type="checkbox" class="custom-control-input" id="customCheck11"
                                                    name="example2" style="width:50px">
                                                <label class="custom-control-label"
                                                    for="customCheck11">Neurology</label>
                                            </div>
                                            <div class="custom-control custom-checkbox col-md-4">
                                                <input type="checkbox" class="custom-control-input" id="customCheck12"
                                                    name="example2" style="width:50px">
                                                <label class="custom-control-label" for="customCheck12">Obstetrics &
                                                    Gynecology</label>
                                            </div>
                                            <div class="custom-control custom-checkbox col-md-4">
                                                <input type="checkbox" class="custom-control-input" id="customCheck13"
                                                    name="example2" style="width:50px">
                                                <label class="custom-control-label" for="customCheck13">Oncology
                                                </label>
                                            </div>
                                            <div class="custom-control custom-checkbox col-md-4">
                                                <input type="checkbox" class="custom-control-input" id="customCheck14"
                                                    name="example2" style="width:50px">
                                                <label class="custom-control-label" for="customCheck14">Ophthalmology
                                                </label>
                                            </div>
                                            <div class="custom-control custom-checkbox col-md-4">
                                                <input type="checkbox" class="custom-control-input" id="customCheck15"
                                                    name="example2" style="width:50px">
                                                <label class="custom-control-label" for="customCheck15">Orthopedics
                                                </label>
                                            </div>
                                            <div class="custom-control custom-checkbox col-md-4">
                                                <input type="checkbox" class="custom-control-input" id="customCheck16"
                                                    name="example2" style="width:50px">
                                                <label class="custom-control-label" for="customCheck16">Pain Medicine
                                                </label>
                                            </div>
                                            <div class="custom-control custom-checkbox col-md-4">
                                                <input type="checkbox" class="custom-control-input" id="customCheck17"
                                                    name="example2" style="width:50px">
                                                <label class="custom-control-label" for="customCheck17">Otolaryngology
                                                </label>
                                            </div>
                                            <div class="custom-control custom-checkbox col-md-4">
                                                <input type="checkbox" class="custom-control-input" id="customCheck18"
                                                    name="example2" style="width:50px">
                                                <label class="custom-control-label" for="customCheck18">Pediatric &
                                            ...
                                            <div class="custom-control custom-checkbox col-md-4">
                                                <input type="checkbox" class="custom-control-input" id="customCheck19"
                                                    name="example2" style="width:50px">
                                                <label class="custom-control-label" for="customCheck19">Pediatric
                                                    Cardiology
                                                </label>
                                            </div>
                                            <div class="custom-control custom-checkbox col-md-4">
                                                <input type="checkbox" class="custom-control-input" id="customCheck20"
                                                    name="example2" style="width:50px">
                                                <label class="custom-control-label" for="customCheck20"> Pediatrics
                                                </label>
                                            </div>
                                            <div class="custom-control custom-checkbox col-md-4">
                                                <input type="checkbox" class="custom-control-input" id="customCheck21"
                                                    name="example2" style="width:50px">
                                                <label class="custom-control-label" for="customCheck21"> Physical
                                            ...
                                            <div class="custom-control custom-checkbox col-md-4">
                                                <input type="checkbox" class="custom-control-input" id="customCheck22"
                                                    name="example2" style="width:50px">
                                                <label class="custom-control-label" for="customCheck22"> Plastic Surgery
                                                </label>
                                            </div>
                                            <div class="custom-control custom-checkbox col-md-4">
                                                <input type="checkbox" class="custom-control-input" id="customCheck23"
                                                    name="example2" style="width:50px">
                                                <label class="custom-control-label" for="customCheck23"> Psychiatry
                                                </label>
                                            </div>
                                            <div class="custom-control custom-checkbox col-md-4">
                                                <input type="checkbox" class="custom-control-input" id="customCheck24"
                                                    name="example2" style="width:50px">
                                                <label class="custom-control-label" for="customCheck24"> Pulmonology
                                                </label>
                                            </div>
                                            <div class="custom-control custom-checkbox col-md-4">
                                                <input type="checkbox" class="custom-control-input" id="customCheck25"
                                                    name="example2" style="width:50px">
                                                <label class="custom-control-label" for="customCheck25"> Renal Dialysis
                                                </label>
                                            </div>
                                            <div class="custom-control custom-checkbox col-md-4">
                                                <input type="checkbox" class="custom-control-input" id="customCheck26"
                                                    name="example2" style="width:50px">
                                                <label class="custom-control-label" for="customCheck26"> Rheumatology
                                                </label>
                                            </div>
                                            <div class="custom-control custom-checkbox col-md-4">
                                                <input type="checkbox" class="custom-control-input" id="customCheck27"
                                                    name="example2" style="width:50px">
                                                <label class="custom-control-label" for="customCheck27"> Sleep Medicine
                                                    (restricted)
                                                </label>
                                            </div>
                                            <div class="custom-control custom-checkbox col-md-4">
                                                <input type="checkbox" class="custom-control-input" id="customCheck28"
                                                    name="example2" style="width:50px">
                                                <label class="custom-control-label" for="customCheck28"> Sports Medicine
                                                </label>
                                            </div>
                                            <div class="custom-control custom-checkbox col-md-4">
                                                <input type="checkbox" class="custom-control-input" id="customCheck29"
                                                    name="example2" style="width:50px">
                                                <label class="custom-control-label" for="customCheck29"> Surgical
                                            ...
                                            <div class="custom-control custom-checkbox col-md-4">
                                                <input type="checkbox" class="custom-control-input" id="customCheck30"
                                                    name="example2" style="width:50px">
                                                <label class="custom-control-label" for="customCheck30"> Undersea &
                                            ...
                                            <div class="custom-control custom-checkbox col-md-4">
                                                <input type="checkbox" class="custom-control-input" id="customCheck31"
                                                    name="example2" style="width:50px">
                                                <label class="custom-control-label" for="customCheck31"> Urology
                                                </label>
                                            </div>
                                            ...
                                            <div class="  col-md-12">
                                                <label class="label" for="customCheck18">Others</label>
                                ...
                                <div class="row">
                                    <div class="col-md-9 offset-md-3">
                                        <div class="form-group mt-0 terms">
                                            ...
                                            <label for="radio-4">
                                                <span class="dot"></span> You accept our <a href="#">Terms and
