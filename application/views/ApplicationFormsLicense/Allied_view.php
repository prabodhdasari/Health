                            ...
                            <form action="#" class="job-post-form">
                                <div class="basic-info-input">
                                    ...
                                    <div id="Fee" class="collapse col-md-12">
                                        Allied Health Professional license Fees:
                                        <ul>
                                    ...
                                    <div id="information" class="row">
                                        <label class="col-md-3 col-form-label">AHP Sepeciality</label>
                                        <div class="col-md-9">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <select class="form-control">
                                                            ...
                                                            <option>Audiology Assistant</option>
                                                            <option>Cardiovascular Technologist </option>
                                                            <option>Career Counselor</option>
                                                            <option>Clinical Embryologist</option>
                                                            <option>Couples & Family Counselor</option>
                                                            ...
                                                            <option>Electroencephalogram Technician</option>
                                                            <option>Emergency First Responder</option>
                                                            <option>Emergency Medical Technician-Basic</option>
                                                            <option>Emergency Medical Technician-Intermediate</option>
                                                            <option>Emergency Medical Technician-Paramedic</option>
                                                            <option>Hair Transplant Technician</option>
                                                            <option>Laser Therapist</option>
                                                            <option>Medical Laboratory Assistant</option>
                                                            <option>Medical Laboratory Technologist</option>
                                                            <option>Medical Physicist</option>
                                                            <option>Molecular Biology Technologist</option>
                                                            <option>Nutritionist</option>
                                                            <option>Occupational Therapist</option>
                                                            <option>Optometrist</option>
                                                            <option>Optometry Technician</option>
                                                            <option>Orthotist</option>
                                                            <option>Orthotist Technician</option>
                                                            ...
                                                            <option>Prosthetist Technician</option>
                                                            <option>Psychologist</option>
                                                            <option>Pulmonary Function Technologist</option>
                                                            <option>Radiology Technologist</option>
                                    ...
                                    <div id="details" class="row">
                                        ...
                                        <div class="col-md-9">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <small id="emailHelp" class="form-text text-muted">Year of
                                                            passing</small>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <small id="text" class="form-text text-muted">Admission number
                                                            or Roll number</small>
                                                    </div>
                                                </div>
                                                <div class="col-md-9 text-right">
                                                    <div class="add-cv">
                                            ...
                                            <div class=" col-md-12 dropdown header-top-account login-modals text-right">
                                                <button title="Title" type="button" data-toggle="modal" data-target="#educationModel">+
                                    ...
                                    <div id="details" class="row">
                                        ...
                                        <div class="col-md-9">
                                            <div class="row">
                                                ...
                                                <div class=" col-md-12 dropdown header-top-account login-modals text-right">
                                                    <button title="Title" type="button" data-toggle="modal" data-target="#experienceModel">+
