  ...
  <div class="alice-bg section-padding-bottom mt-0">
    <div class="container no-gliters">
      <div class="row no-gliters">
        ...
        echo form_open('Allied/addNewOrUpdate',$opts); ?>
                  <h4><i data-feather="plus-circle"></i>Application Form - New Allied Health
                    ...
                    <div class="col-md-9">
                      <div class="row">
                        <div class="col-md-12">
                          <div class="form-group">
                          <?php   
                                             $speciality=array('Select Speciality','Anesthesia Technician','Addiction Counselor','Audiologist','Audiology Assistant','Cardiovascular Technologist ','Career Counselor','Clinical Embryologist','Couples & Family Counselor','Cytotechnologist','Dental Hygienist','Dental Technician','Dialysis Technician','Electroencephalogram Technician','Emergency First Responder','Emergency Medical Technician-Basic','Emergency Medical Technician-Intermediate','Emergency Medical Technician-Paramedic','Hair Transplant Technician','Laser Therapist','Medical Laboratory Assistant','Medical Laboratory Technologist','Medical Physicist','Molecular Biology Technologist','Nutritionist','Occupational Therapist','Optometrist','Optometry Technician','Orthotist','Orthotist Technician','Perfusionist','Pharmacist','Pharmacy Technician','Physical Therapist','Physical Therapy Assistant','Physician Assistant','Podiatrist',
                                             'Prosthetist','Prosthetist Technician','Psychologist','Pulmonary Function Technologist','Radiology Technologist','Rehabilitation Counselor','Respiratory Therapist','Respiratory Therapy Technician','School Counselor','Sleep Lab Technician','Speech Language Pathologist','Speech Language Pathology Assistant','Ultrasonographer',
); 
