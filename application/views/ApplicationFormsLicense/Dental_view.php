            ...
            <div class="post-content-wrapper">
              <form action="#" class="job-post-form">
                <div class="basic-info-input">
                  ...
                  <div id="information" class="row">
                    <label class="col-md-3 col-form-label">Dental Speciality</label>
                    <div class="col-md-9">
                      <div class="row">
                        <div class="col-md-12">
                          <div class="form-group">
                            <select class="form-control">
                                    ...
                                    <option>Dental Public Health</option>
                                    <option>Endodontics</option>
                                    <option>Oral & Maxillofacial Pathology</option>
                                    <option>Oral & Maxillofacial Radiology</option>
                                    <option>Oral & Maxillofacial Surgery</option>
                                    <option>Oral Medine</option>
                                    <option>Orthodontics & Dentofacial Orthopedics</option>
