  ...
  <div class="alice-bg section-padding-bottom mt-0">
    <div class="container no-gliters">
      <div class="row no-gliters">
        ...
        echo form_open('Nurse/addNewOrUpdate',$opts); ?>
                  <h4><i data-feather="plus-circle"></i>Application Form - New Nurse License</h4>
                    ...
                    <div class="col-md-9">
                      <div class="row">
                        <div class="col-md-12">
                          <div class="form-group">
                          <?php   
                                             $speciality=array(   'Select Speciality','Registered Nurse','Registered Midwife','Practical Nurse',
); 
