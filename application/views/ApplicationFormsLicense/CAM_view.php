  ...
  <div class="alice-bg section-padding-bottom mt-0">
    <div class="container no-gliters">
      <div class="row no-gliters">
        ...
        echo form_open('CAM/addNewOrUpdate',$opts); ?>
                  <h4><i data-feather="plus-circle"></i>Application Form - COMPLEMENTARY & ALTERNATIVE MEDICINE LICENSE</h4>
                    ...
                    <div class="col-md-9">
                      <div class="row">
                        <div class="col-md-12">
                          <div class="form-group">
                          <?php   
                                             $speciality=array( 'Select Speciality','Doctor of Osteopathy','Doctor of Medicine with CAM Speciality - Osteopathy','Doctor of Medicine with CAM Speciality - Chiropractic','Doctor of Medicine with CAM Speciality - Traditional Chinese Medicine ','Doctor of Medicine with CAM Speciality - Homeopathy','Doctor of Medicine with CAM Speciality - Naturopathy ','Doctor of Medicine with CAM Speciality - Ayurveda','Doctor of Medicine with CAM Speciality - Therapeutic Massage','Doctor of Medicine with CAM Speciality - Unani','Doctor of CAM - Osteopathy','Doctor of CAM - Chiropractic','Doctor of CAM - Traditional Chinese Medicine ','Doctor of CAM - Homeopath ', 'Doctor of CAM - Naturopathy ','Doctor of CAM - Ayurveda','Doctor of CAM - Therapeutic Massage','Doctor of CAM - Unani','Associate Doctor of CAM - Osteopathy','Associate Doctor of CAM - Chiropractic','Associate Doctor of CAM - Traditional Chinese Medicine ','Associate Doctor of CAM - Homeopathy','Associate Doctor of CAM - Naturopathy ','Associate Doctor of CAM - Ayurveda','Associate Doctor of CAM - Therapeutic Massage','Associate Doctor of CAM - Unani','CAM Therapist - Traditional Chinese Medicine','CAM Therapist - Therapeutic Massage',); 
