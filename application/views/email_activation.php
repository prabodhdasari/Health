                                    ...
                                    <tr>
                                        <td valign="top" class="mobile-block mobile-no-padding-bottom mobile-center"
                                            ...
                                            <a href="#" style="text-decoration:none;">
                                                <img src="https://www.filepicker.io/api/file/X9R4FqRPaEIS3vMxFXgl"
                                                    width="142" height="30" alt="Your Logo" />
                                            </a>
                                        </td>
                                        <td valign="top" class="mobile-block mobile-center" width="270"
                                            style="background:#1f1f1f;padding:10px 15px 10px 10px">
                                            <table border="0" cellpadding="0" cellspacing="0"
                                                class="mobile-center-block" align="right">
                                                <tr>
                                                    <td align="right">
                                                        <a href="#">
                                                            <img src="http://keenthemes.com/assets/img/emailtemplate/social_facebook.png"
                                                                width="30" height="30" alt="social icon" />
                                                        </a>
                                                    </td>
                                                    <td align="right" style="padding-left:5px">
                                                        <a href="#">
                                                            <img src="http://keenthemes.com/assets/img/emailtemplate/social_twitter.png"
                                                                width="30" height="30" alt="social icon" />
                                                        </a>
                                                    </td>
                                                    <td align="right" style="padding-left:5px">
                                                        <a href="#">
                                                            <img src="http://keenthemes.com/assets/img/emailtemplate/social_googleplus.png"
                                                                width="30" height="30" alt="social icon" />
                                                        </a>
                                                    </td>
                                                    <td align="right" style="padding-left:5px">
                                                        <a href="#">
                                                            <img src="http://keenthemes.com/assets/img/emailtemplate/social_linkedin.png"
                                                                width="30" height="30" alt="social icon" />
                                                        </a>
                                                    </td>
                                                    <td align="right" style="padding-left:5px">
                                                        <a href="#">
                                                            <img src="http://keenthemes.com/assets/img/emailtemplate/social_rss.png"
                                                                width="30" height="30" alt="social icon" />
                                                        </a>
                                                    </td>
                                                </tr>
                    ...
                    <tr>
                        <td style="border-bottom:1px solid #e7e7e7;">
                                    ...
                                    <tr>
                                        <td align="left" class="mobile-padding" style="padding:20px 20px 0">
                                           ...
                                           <h3> <?php echo $userName;   ?><h3>
                                            <h1>Welcome to Xsilica</h1>

                                            <br>
                                            We're excited you're here! Learn more about Awesome Co and activate your new
                                            account by clicking the link below!<br>
                                            <br>
                          ...
                          <![endif]-->
                                                             ...
                                                             <a href=  <?php echo $verification_key;   ?> 
                                            ...
                                            <table cellspacing="0" cellpadding="0" width="100%">
                                                <tr>
                                                    <td align="right" valign="bottom" width="220"
                                                        style="padding-right:20px; padding-bottom:0; vertical-align:bottom;">
                                                        <img style="display:block"
                                                            src="https://www.filepicker.io/api/file/AvB8yENR7OdiUqonW05y"
                                                            width="174" height="294" alt="iphone" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" width="600" class="w320"
                                    ...
                                    <tr>
                                        <td valign="top" class="mobile-padding" style="padding:20px;">
                                            <h2>Enjoy 50% off!</h2>
                                            <br>
                                            You'll be the first to hear about new arrivals, exclusive promotionas, cool
                                            collaborations, and the latest in everything.<br>
                                            <br>
