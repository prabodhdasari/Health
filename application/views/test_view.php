                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="menu-item dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="menu-item"><a href="job-listing-with-map.html">Job Listing With
                                                Map</a></li>
                                ...
                                <li class="menu-item dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="menu-item"><a href="candidate-details.html">Candidate Details</a>
                                        </li>
                                ...
                                <li class="menu-item dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="menu-item"><a href="employer-dashboard-post-job.html">Post a Job</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="menu-item dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li class="menu-item dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li class="menu-item"><a href="dashboard-edit-profile.html">Edit
                                                        Profile</a></li>
                                                <li class="menu-item"><a href="add-resume.html">Add Resume</a></li>
                                                <li class="menu-item"><a href="resume.html">Resume</a></li>
                                                <li class="menu-item"><a href="edit-resume.html">Edit Resume</a></li>
                                                <li class="menu-item"><a href="dashboard-bookmark.html">Bookmarked</a>
                                                </li>
                                        ...
                                        <li class="menu-item dropdown">
                                            <a href="#" data-toggle="dropdown" class="dropdown-toggle"
                                                ...
                                                Dashboard</a>
                                            <ul class="dropdown-menu">
                                                <li class="menu-item"><a href="employer-dashboard.html">Employer
                                                        Dashboard</a></li>
                                                <li class="menu-item"><a
                                                        href="employer-dashboard-edit-profile.html">Edit Profile</a>
                                                </li>
                                                <li class="menu-item"><a
                                                        href="employer-dashboard-manage-candidate.html">Manage
                                                        Candidate</a></li>
                                                <li class="menu-item"><a
                                                        href="employer-dashboard-manage-job.html">Manage Job</a></li>
                                                <li class="menu-item"><a
                                                        href="employer-dashboard-message.html">Dashboard Message</a>
                                                </li>
                                                <li class="menu-item"><a
                                                        href="employer-dashboard-pricing.html">Dashboard Pricing</a>
                                                </li>
                                                <li class="menu-item"><a href="employer-dashboard-post-job.html">Post
                                                        Job</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                ...
                                <li class="menu-item dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="menu-item"><a href="terms-and-condition.html">Terms And Condition</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="menu-item"><a href="contact.html">Contact Us</a></li>
                                <li class="menu-item post-job"><a href="post-job.html"><i class="fas fa-plus"></i>Post a
                                        Job</a></li>
                            </ul>
                        </div>
                    </nav>
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="contact-address">
                                    <h4>Contact Info</h4>
                                    <ul>
                                        <li><i data-feather="map-pin"></i>International Noel Nawab Street Los Alamitos
                                            CA 90720, USA</li>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <input type="text" class="box" name="" required="">
                                                    <label> Name</label>
                                                </div>
                                            </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <div id="map-area" class="contact-map">
                                    <div class="cp-map" id="location" data-lat="40.713355" data-lng="-74.005535"
                                        data-zoom="10"></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="footer-bottom border-top">
                            <div class="row">
                                ...
                                <div class="col-xl-4 col-lg-4 order-lg-1">
                                    <p class="copyright-text">Copyright <a href="#">Oficiona</a> 2018, All right
                                        reserved</p>
                                </div>
