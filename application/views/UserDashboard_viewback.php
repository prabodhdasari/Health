                  ...
                  <div class="account-card">
                    <div class="header-top-account-info">
                      <a href="#" class="account-thumb">
                        <img src="images\account\thumb-1.jpeg" class="img-fluid" alt="">
                      </a>
          ...
          <div class="col">
            <div class="dashboard-container">
                ...
                <div class="dashboard-applied">
                  ...
                  <div class="dashboard-apply-area">
                    <div class="job-list">
                      ...
                      <div class="body">
                        <div class="content">
                          <h4><a href="#">Designer Required</a></h4>
                          <div class="info">
              ...
              <div class="dashboard-sidebar">
                <div class="user-info">
                  <div class="thumb">
                    <img src="dashboard\images\user-1.jpeg" class="img-fluid" alt="">
                  </div>
                  <div class="user-body">
                    <h5>Lula Wallace</h5>
                    <span>@username</span>
                ...
                <div class="dashboard-menu">
                  <ul>
                    ...
                    <li class="active"><i class="fas fa-check-square"></i><a href="dashboard-applied.html">Applied Job</a></li>
